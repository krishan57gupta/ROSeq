file="~/ROSeq/paper_work/latest_data/noise_jurkat/null_noise_uniform_2_20_"
...
pdf("~/ROSeq/paper_work/latest_plot/noise_jurkat/uniform_noise_combined_all_gene_2_20_pval.pdf",height = 10)
a
dev.off()
a
# ######################################## another way
...
a=ggarrange(plot[[1]],plot[[2]],plot[[3]],plot[[4]],plot[[5]],plot[[6]],
            ncol = 1,nrow=6,common.legend = TRUE)
pdf("~/ROSeq/paper_work/latest_plot/noise_jurkat/uniform_noise_combined_all_sample_2_20_pval.pdf",height = 10)
a
dev.off()
a
